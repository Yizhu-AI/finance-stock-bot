...
def test_save_and_retrieve_single_run():
    ...
    memory.save_run("AAPL", report, run_date="2026-09-01")
...
def test_history_ordered_most_recent_first():
    ...
    memory.save_run("AAPL", report, run_date="2026-09-01")
    memory.save_run("AAPL", report, run_date="2026-09-05")
    memory.save_run("AAPL", report, run_date="2026-09-03")
...
def test_tickers_isolated_from_each_other():
    report = {"signals": [], "llm": None}
    memory.save_run("AAPL", report, run_date="2026-09-01")
    memory.save_run("TSLA", report, run_date="2026-09-01")
